...
public interface CrudDAO<T> {
     ...
     *
     * @param entity objeto a modificar
     * * @author David Timana.
     */
     ...
     * por algun parametro del campo de la entidad
     * por algun parametro solo String. 
     * 
     * @param entityClass
     *          entidad a buscar.
     * @param campo
     ...
     *
     * @param alias sobre nombre puesta a la entidad en la consulta	*
     */
     ...
     *
     * @param id llave primaria del registro a buscar
     ...
     * Buscar un objeto a partir del id
     *
     * @param entityClass tipo de clase {@link Class} perteneciente a una
     * entidad a buscar
     *
     * @return objeto buscado
     *
     ...
     *
     * @param entityClass tipo de entidad a buscar
     *
     * @param alias Coloca un sobre Nombre a la entidad que se consulta por
     * ejemplo para la entidad Persona podria ser "per"
     *
     * @param camposWhere Campos que sirven como filtro en la consulta. Por
     * ejemplo, si la entidad Persona con alias "per" tiene un campo
     * identificacion, el campo seria "per.identificacion". Pero si la misma
     * entidad tiene una relacion con otra entidad, ejemplo telefono, el campo
     * seria "per.telefono.id".
     * @param camposOrderBy Campos usandos para ordenar los resultados.
     *
     ...
     * @param alias Coloca un sobre Nombre a la entidad que se consulta por
     * ejemplo para la entidad Persona podria ser "per"
     * @param campoSelect es el campo que retornara el unico valor, ejemplo
     * SUM(per.salario)
     * @param condicionWhere Campos que sirven como filtro en la consulta. Por
     * ejemplo, si la entidad Persona con alias "per" tiene un campo
     * identificacion, el campo seria "per.identificacion". Pero si la misma
     * entidad tiene una relacion con otra entidad, ejemplo telefono, el campo
     * seria "per.telefono.id".

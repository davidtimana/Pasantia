...
public class Batallon  implements java.io.Serializable {
    private static final long serialVersionUID = 1065774247880671522L;
    ...
    public Batallon(Ciudad ciudad, Divisiones divisiones, Persona persona, String nombreBatallon, String telefono1, String telefono2, String direccion, String barrio, Set<Casino> casinos) {
       this.ciudad = ciudad;
       this.divisiones = divisiones;
